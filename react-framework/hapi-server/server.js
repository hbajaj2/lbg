...
import fluxForm from '../server-files/flux-form';
import isoRenderer from '../server-files/isoRenderer.jsx';
...
server.route({
	method: 'GET',
	path: '/action/{storeName}/{actionName}/',
	handler: function (request, reply) {
		...
		var redirectUrl = actionResults.url;
